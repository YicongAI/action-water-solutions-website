      ...
      {posts.map((post, index) => (
        ...
        >
            ...
            {post.image ? (
              ...
              <>
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="flex size-20 items-center justify-center rounded-[1.4rem] border border-cyan-200/25 bg-white/10 text-cyan-100 backdrop-blur-md">
                    <FileText size={34} strokeWidth={1.35} />
                  </span>
                </div>
              </>
            )}
            <div className="absolute inset-0 bg-gradient-to-t from-[#062b47]/65 via-transparent to-transparent" />
            <span className="absolute left-5 top-5 rounded-full border border-white/20 bg-[#082d49]/70 px-3 py-1.5 text-[9px] font-bold uppercase tracking-[0.15em] text-cyan-100 backdrop-blur-sm">
              {post.category}
            </span>
            <span className="absolute bottom-5 right-5 text-[9px] font-bold tracking-[0.16em] text-white/35">
              0{index + 1}
            </span>
          </div>
          ...
          <div className="flex flex-1 flex-col p-7 sm:p-8">
            ...
            <h2 className="mt-4 text-2xl font-semibold leading-tight tracking-[-0.035em] text-[#082d49]">
              {post.title}
            </h2>
